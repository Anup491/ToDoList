...
namespace ToDoListAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LogInDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ToDoAppCon")));
            services.AddSwaggerGen(c => { c.SwaggerDoc("v1", new OpenApiInfo { Title = "ToDoListAPI", Version = "v1" });});
        }
